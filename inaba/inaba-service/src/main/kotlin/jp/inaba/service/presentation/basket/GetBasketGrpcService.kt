...
class GetBasketGrpcService(
    ...
    override fun handle(request: GetBasketRequest, responseObserver: StreamObserver<GetBasketResponse>) {
    ...
    private fun success(result: FindBasketByIdResult, responseObserver: StreamObserver<GetBasketResponse>) {
    ...
    private fun failure(error: FindBasketByIdError, responseObserver: StreamObserver<GetBasketResponse>) {
