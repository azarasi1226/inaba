...
class GetProductGrpcService(
    ...
    override fun handle(request: GetProductRequest, responseObserver: StreamObserver<GetProductResponse>) {
        val command = FindProductByIdQuery(
    ...
    private fun success(result: FindProductByIdResult, responseObserver: StreamObserver<GetProductResponse>) {
    ...
    private fun failure(error: FindProductByIdError, responseObserver: StreamObserver<GetProductResponse>) {
